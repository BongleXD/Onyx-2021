...
public class ChatListener implements Listener {
    ...
    public void onChat(AsyncPlayerChatEvent e){
        ...
        if(ChatConfig.cfg.getBoolean("enabled")) {
            ...
            if (p.hasPermission("onyx.chat.gg") && !prof.isNicked() || prof.isNicked() && (prof.getNickPrefix().equals("§b[MVP§c+§b] "))) {
            ...
            if (p.hasPermission("onyx.chat.transcolor") && !prof.isNicked() || prof.isNicked() && (prof.getNickPrefix().equals("§b[MVP§c+§b] ") || prof.getNickPrefix().equals("§b[MVP§c+§b] "))) {
