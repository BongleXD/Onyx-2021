...
public class Gamemode extends CommandManager {
    ...
    @Cmd(arg = "<value>", perm = "ncs.command.gamemode", permMessage = "§c你需要 §cADMIN §c及以上的会员等级才能使用此指令！", only = CommandOnly.PLAYER)
    ...
    @Cmd(arg = "<value> <player>", perm = "ncs.command.gamemode.force", permMessage = "§c你需要 §cADMIN §c及以上的会员等级才能使用此指令！")
