...
public class Fly extends CommandManager {
    ...
    public Fly() {
        ...
        this.setPermissionMessage("§c你需要 §9HELPER §c及以上的会员等级才能使用此指令！");
    }

    @Cmd(perm = "ncs.command.fly", permMessage = "§c你需要 §aVIP §c及以上的会员等级才能使用飞行！ 请移步至主大厅进行购买会员等级！", only = CommandOnly.PLAYER)
