...
public class Tp extends CommandManager {
    ...
    @Cmd(arg = "<player> <player>", perm = "onyx.command.tp.force", permMessage = "§c你需要 ADMIN §c及以上的会员等级才能使用此指令！")
    ...
    @Cmd(arg = "<value> <value> <value>", perm = "onyx.command.tp.loc", permMessage = "§c你需要 ADMIN §c及以上的会员等级才能使用此指令！", only = CommandOnly.PLAYER)
    ...
    @Cmd(arg = "<player> <value> <value> <value>", perm = "onyx.command.tp.loc.force", permMessage = "§c你需要 ADMIN §c及以上的会员等级才能使用此指令！")
